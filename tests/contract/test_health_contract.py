...
def test_openapi_contains_verified_runtime_routes(client: TestClient) -> None:
    ...
    assert paths == {
        "/api/v1/global-reconciliation/status", "/api/v1/health", "/api/v1/health/live",
        "/api/v1/health/ready", "/api/v1/indicators/{symbol}",
        "/api/v1/journal-performance/journal", "/api/v1/journal-performance/performance",
        "/api/v1/journal-performance/reports", "/api/v1/journal-performance/status",
        "/api/v1/lifecycle-reconciliation/status", "/api/v1/market/klines/{symbol}",
        "/api/v1/market/status", "/api/v1/market/symbols", "/api/v1/market/ticker/{symbol}",
        "/api/v1/execution/demo/activate/{signal_id}", "/api/v1/execution/demo/account",
        "/api/v1/execution/demo/commands", "/api/v1/execution/demo/commands/status",
        "/api/v1/execution/demo/commands/{command_id}",
        "/api/v1/execution/demo/commands/{command_id}/history", "/api/v1/execution/demo/plans",
        "/api/v1/execution/demo/status", "/api/v1/execution/demo/trades",
        "/api/v1/execution/demo/worker/status", "/api/v1/notifications",
        "/api/v1/notifications/status", "/api/v1/notifications/{notification_id}",
        "/api/v1/notifications/{notification_id}/read", "/api/v1/order-audit/orders",
        "/api/v1/order-audit/status", "/api/v1/order-reconciliation/status",
        "/api/v1/position-reconciliation/status", "/api/v1/protective-lifecycle/status",
        "/api/v1/restart-recovery/status", "/api/v1/risk/assessments", "/api/v1/risk/status",
        "/api/v1/scanner/candidates", "/api/v1/scanner/run-now", "/api/v1/scanner/runs/latest",
        "/api/v1/scanner/start", "/api/v1/scanner/status", "/api/v1/scanner/stop",
        "/api/v1/signals", "/api/v1/signals/{signal_id}", "/api/v1/signals/status",
        "/api/v1/system/status", "/api/v1/trade-management/close/{trade_id}",
        "/api/v1/trade-management/status", "/api/v1/trade-management/trades", "/api/v1/universe",
    }
